  ...
  render() {
    return (
      <Html className="dark">
        ...
        <body className="bg-gradient-to-br from-indigo-100 to-indigo-200 dark:from-indigo-900 dark:to-gray-800 text-black md:text-xl duration-150 dark:text-white">
          <Main />
          <NextScript />
        </body>
      </Html>
