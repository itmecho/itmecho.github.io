...
summary: 'Installing and configuring fluentbit to forward your system logs to DataDog (or another destination!)'
date: '2020-06-17'
featureImage: '/images/sending-system-logs-to-datadog-using-fluentbit/feature.jpg'
---
