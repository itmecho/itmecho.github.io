...
summary: 'Showing the shell syntax for setting a default vaule for environment variables'
date: '2020-06-16'
featureImage: '/images/set-defaults-for-environment-variables/feature.jpg'
---
